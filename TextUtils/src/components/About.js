...
export default function About(props) {
  ...
  return (
    ...
    <textarea className="form-control" id="Feedback" placeholder='Enter feedback here' rows="3"></textarea>
    <button className="btn btn-primary my-2 mx-2"  onClick={Sent} >Submit</button>
    </div>
    </div>
    </>
  )
